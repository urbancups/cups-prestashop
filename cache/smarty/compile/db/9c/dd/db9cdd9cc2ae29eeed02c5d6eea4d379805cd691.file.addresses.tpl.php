<?php /* Smarty version Smarty-3.1.14, created on 2013-10-30 21:15:01
         compiled from "/var/www/themes/theme762/addresses.tpl" */ ?>
<?php /*%%SmartyHeaderCode:59333583852715ab58f6ff7-63952263%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'db9cdd9cc2ae29eeed02c5d6eea4d379805cd691' => 
    array (
      0 => '/var/www/themes/theme762/addresses.tpl',
      1 => 1382895405,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '59333583852715ab58f6ff7-63952263',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52715ab5bc5539_23662044',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52715ab5bc5539_23662044')) {function content_52715ab5bc5539_23662044($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/tools/smarty/plugins/function.counter.php';
...
<h1><span><?php echo smartyTranslate(array('s'=>'My addresses'),$_smarty_tpl);?>
</span></h1>
...
<div class="addresses titled_box">
	<h2><span><?php echo smartyTranslate(array('s'=>'Your addresses are listed below.'),$_smarty_tpl);?>
</span></h2>
...
?>
		<ul class="address span3 <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['last']){?>last_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['first']){?>first_item<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['index']%2){?>alternate_item<?php }else{ ?>item<?php }?>">
...
<?php }else{ ?>
	<p class="warning"><i class="icon-info-sign"></i><?php echo smartyTranslate(array('s'=>'No addresses are available.'),$_smarty_tpl);?>
