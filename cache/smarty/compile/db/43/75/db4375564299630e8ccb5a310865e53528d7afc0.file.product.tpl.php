<?php /* Smarty version Smarty-3.1.14, created on 2013-10-27 20:12:53
         compiled from "/var/www/themes/theme762/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1809044225526d57a5d497a7-24500813%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'db4375564299630e8ccb5a310865e53528d7afc0' => 
    array (
      0 => '/var/www/themes/theme762/product.tpl',
      1 => 1382895424,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1809044225526d57a5d497a7-24500813',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_526d57a6c39d39_64091794',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526d57a6c39d39_64091794')) {function content_526d57a6c39d39_64091794($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/tools/smarty/plugins/modifier.escape.php';
...
<div id="pb-right-column" class="span4">
	...
	<!-- product img-->
		...
		<?php if ($_smarty_tpl->tpl_vars['have_image']->value){?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['jqZoomEnabled']->value){?><a id="zoom1" rel="position: 'inside' , showTitle: false, adjustX:0, adjustY:0" class="cloud-zoom" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'thickbox_default');?>
">
...
" src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'thickbox_default');?>
" >
...
" />
		...
		<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>4){?><a id="view_scroll_left"  title="<?php echo smartyTranslate(array('s'=>'Other views'),$_smarty_tpl);?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']>0){?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value>=0&&$_smarty_tpl->tpl_vars['priceDisplay']->value<=2){?>
                                <?php if ($_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value>$_smarty_tpl->tpl_vars['productPrice']->value){?>
                                    <span id="old_price_display price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value),$_smarty_tpl);?>
</span>
				...
				<?php }?>
                    ...
                    <?php }else{ ?>
                        <p id="add_to_cart" class="buttons_bottom_block">
                            ...
                            <a class="exclusive button btn_add_cart" href="javascript:document.getElementById('add2cartbtn').click();"> <span><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
  </span></a>
...
<?php }?></span><?php }?>
									...
									<a class="exclusive button ajax_add_to_cart_button btn_add_cart" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['accessory']->value['id_product']);?>
