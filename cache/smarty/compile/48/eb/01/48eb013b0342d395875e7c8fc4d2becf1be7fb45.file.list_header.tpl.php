<?php /* Smarty version Smarty-3.1.14, created on 2013-10-28 23:19:20
         compiled from "/var/www/admincups/themes/default/template/controllers/supply_orders/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1914637802526ed4d8d3ec17-20695982%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '48eb013b0342d395875e7c8fc4d2becf1be7fb45' => 
    array (
      0 => '/var/www/admincups/themes/default/template/controllers/supply_orders/helpers/list/list_header.tpl',
      1 => 1382387050,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1914637802526ed4d8d3ec17-20695982',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_526ed4d921e0e5_18092871',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526ed4d921e0e5_18092871')) {function content_526ed4d921e0e5_18092871($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/tools/smarty/plugins/modifier.escape.php';
?>
...
"><?php echo $_smarty_tpl->tpl_vars['i']->value['name'];?>
		...
		<div style="margin-top: 5px;">
			<label for="filter_status"><?php echo smartyTranslate(array('s'=>'Choose not to display completed/canceled orders:'),$_smarty_tpl);?>
</label>
			<input type="checkbox" name="filter_status" class="noborder" onChange="$(this).parent().parent().submit();" <?php if ($_smarty_tpl->tpl_vars['filter_status']->value==1){?>value="on" checked<?php }?>></input>
		</div>
	</form>
</div>
<?php }?>
