<?php /* Smarty version Smarty-3.1.14, created on 2013-10-30 20:54:38
         compiled from "/var/www/themes/theme762/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1208789857527155ee7bad95-63036366%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2744af7f24ba5653fb3eeb8efca061772694da37' => 
    array (
      0 => '/var/www/themes/theme762/order-address.tpl',
      1 => 1382895416,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1208789857527155ee7bad95-63036366',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_527155eee6b220_10653756',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_527155eee6b220_10653756')) {function content_527155eee6b220_10653756($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/tools/smarty/plugins/function.counter.php';
...
<?php if (!$_smarty_tpl->tpl_vars['opc']->value){?><h1><span><?php echo smartyTranslate(array('s'=>'Addresses'),$_smarty_tpl);?>
</span></h1><?php }else{ ?><h2><span>1</span> <?php echo smartyTranslate(array('s'=>'Addresses'),$_smarty_tpl);?>
</h2><?php }?>
...
<?php $_tmp4=ob_get_clean();?><?php if (!$_smarty_tpl->tpl_vars['multi_shipping']->value&&$_tmp4&&!$_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()){?>
		<div class="button_multishipping_mode titled_box" id="multishipping_mode_box">
			<h2><span><?php echo smartyTranslate(array('s'=>'Multi-shipping'),$_smarty_tpl);?>
</span></h2>
			<div class="description">
				<a class="btn btn-large btn-block" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1&multi-shipping=1');?>
"/>
...
" id="link_multishipping_form" class="btn" title="<?php echo smartyTranslate(array('s'=>'Choose the delivery address(es)'),$_smarty_tpl);?>
">
...
" <?php if ($_smarty_tpl->tpl_vars['addresses']->value[$_smarty_tpl->getVariable('smarty')->value['section']['address']['index']]['id_address']==$_smarty_tpl->tpl_vars['cart']->value->id_address_invoice&&$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery!=$_smarty_tpl->tpl_vars['cart']->value->id_address_invoice){?>selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['addresses']->value[$_smarty_tpl->getVariable('smarty')->value['section']['address']['index']]['alias'], 'htmlall', 'UTF-8');?>
			...
			<?php }else{ ?>
				<a href="<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value){?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp6=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1&select_address=1".$_tmp6);?>
