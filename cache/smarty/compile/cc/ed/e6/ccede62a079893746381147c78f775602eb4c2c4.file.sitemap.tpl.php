<?php /* Smarty version Smarty-3.1.14, created on 2013-10-30 21:53:54
         compiled from "/var/www/themes/theme762/sitemap.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1736631304527163d2bc9d47-36248239%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ccede62a079893746381147c78f775602eb4c2c4' => 
    array (
      0 => '/var/www/themes/theme762/sitemap.tpl',
      1 => 1382895427,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1736631304527163d2bc9d47-36248239',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_527163d2da9dd1_99053629',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_527163d2da9dd1_99053629')) {function content_527163d2da9dd1_99053629($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/tools/smarty/plugins/modifier.escape.php';
?>
...
"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'New products'),$_smarty_tpl);?>
</a></li>
...
"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Best sellers'),$_smarty_tpl);?>
</a></li>
...
"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Price drop'),$_smarty_tpl);?>
</a></li>
			<?php }?>
...
"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Manufacturers:'),$_smarty_tpl);?>
</a></li><?php }?>
...
"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Suppliers:'),$_smarty_tpl);?>
</a></li><?php }?>
		</ul>
	</div>
	<div class="sitemap_block titled_box span3">
...
" rel="nofollow"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Your Account'),$_smarty_tpl);?>
</a></li>
...
" rel="nofollow"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Personal information'),$_smarty_tpl);?>
</a></li>
...
" rel="nofollow"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Addresses'),$_smarty_tpl);?>
</a></li>
...
" rel="nofollow"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Discounts'),$_smarty_tpl);?>
</a></li><?php }?>
...
" rel="nofollow"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Order history'),$_smarty_tpl);?>
</a></li>
		<?php }else{ ?>
...
" rel="nofollow"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Authentication'),$_smarty_tpl);?>
</a></li>
			<li><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true);?>
" title="<?php echo smartyTranslate(array('s'=>'Create new account'),$_smarty_tpl);?>
"rel="nofollow"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Create new account'),$_smarty_tpl);?>
</a></li>
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['logged']->value){?>
...
" rel="nofollow"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Log out'),$_smarty_tpl);?>
</a></li>
		<?php }?>
		</ul>
	</div>
...
"><i class="icon-caret-right"></i> <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['categoriescmsTree']->value['name'], 'htmlall', 'UTF-8');?>
</a></li>
...
"><i class="icon-caret-right"></i> <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cms']->value['meta_title'], 'htmlall', 'UTF-8');?>
</a></li>
                        <?php } ?>
...
"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Contact'),$_smarty_tpl);?>
</a></li>
...
"><i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'Our stores'),$_smarty_tpl);?>
</a></li><?php }?>
				</ul>
	</div>
</div>
