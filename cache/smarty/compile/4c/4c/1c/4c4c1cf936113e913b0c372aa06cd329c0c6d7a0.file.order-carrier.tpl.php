<?php /* Smarty version Smarty-3.1.14, created on 2013-10-30 20:55:11
         compiled from "/var/www/themes/theme762/order-carrier.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2309261335271560fb51a55-62142314%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4c4c1cf936113e913b0c372aa06cd329c0c6d7a0' => 
    array (
      0 => '/var/www/themes/theme762/order-carrier.tpl',
      1 => 1382895417,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2309261335271560fb51a55-62142314',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52715610007103_05779479',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52715610007103_05779479')) {function content_52715610007103_05779479($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php }?>
<?php if (!$_smarty_tpl->tpl_vars['opc']->value){?>
	<h1><span><?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>
</span></h1>
<?php }else{ ?>
...
<?php }else{ ?>
	<h2 class="carrier_title"><span><?php echo smartyTranslate(array('s'=>'Choose your delivery method'),$_smarty_tpl);?>
</span></h2>
...
?>
 ...
 <?php echo smartyTranslate(array('s'=>'(tax excl.)'),$_smarty_tpl);?>
						...
						<table class="delivery_option_carrier std <?php if (isset($_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value])&&$_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value]==$_smarty_tpl->tpl_vars['key']->value){?>selected<?php }?> <?php if ($_smarty_tpl->tpl_vars['option']->value['unique_carrier']){?>not-displayable<?php }?>">
							<?php  $_smarty_tpl->tpl_vars['carrier'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['carrier']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['option']->value['carrier_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['carrier']->total= $_smarty_tpl->_count($_from);
 $_smarty_tpl->tpl_vars['carrier']->iteration=0;
...
?>
	...
	<div style="display: none;" id="extra_carrier"></div>
		...
		<h2 class="gift_title"><span><?php echo smartyTranslate(array('s'=>'Gift'),$_smarty_tpl);?>
</span></h2>
		</div>
        <p class="checkbox">
...
<div>
	<h2 class="condition_title titled_box"><span><?php echo smartyTranslate(array('s'=>'Terms of service'),$_smarty_tpl);?>
</span></h2>
	</div>
    <p class="checkbox">
