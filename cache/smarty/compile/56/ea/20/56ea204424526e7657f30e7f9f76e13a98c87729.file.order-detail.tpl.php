<?php /* Smarty version Smarty-3.1.14, created on 2013-10-30 21:37:50
         compiled from "/var/www/themes/theme762/order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11057723405271600e405c03-86769289%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56ea204424526e7657f30e7f9f76e13a98c87729' => 
    array (
      0 => '/var/www/themes/theme762/order-detail.tpl',
      1 => 1382895418,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11057723405271600e405c03-86769289',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5271600ed36541_90354905',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5271600ed36541_90354905')) {function content_5271600ed36541_90354905($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/tools/smarty/plugins/modifier.escape.php';
...
<?php if ($_smarty_tpl->tpl_vars['carrier']->value->id){?><p class="tit-ord"><strong><?php echo smartyTranslate(array('s'=>'Carrier'),$_smarty_tpl);?>
...
<?php }?></p><?php }?>
<p class="tit-ord"><strong><?php echo smartyTranslate(array('s'=>'Payment method'),$_smarty_tpl);?>
...
icon/recyclable.png" alt="" class="icon" />&nbsp;<?php echo smartyTranslate(array('s'=>'You have given permission to receive your order in recycled packaging.'),$_smarty_tpl);?>
</p>
<?php }?>
...
<div class="titled_box"> 
<h2><span><?php echo smartyTranslate(array('s'=>'Follow your order\'s status step-by-step'),$_smarty_tpl);?>
</span></h2>
</div>
...
<div id="order-detail-content" class="table_block">
	<table id="order-detail-content-table" class="std shop_table footable">
		<thead>
			<tr>
            	<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value){?><th data-hide="phone,tablet"  class="first_item "><input type="checkbox" /></th><?php }?>
                <th data-hide="phone,tablet" class="<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value){?>item<?php }else{ ?>first_item<?php }?>"><?php echo smartyTranslate(array('s'=>'Reference'),$_smarty_tpl);?>
</th>
            	<th  data-class="expand" class="item"><?php echo smartyTranslate(array('s'=>'Product'),$_smarty_tpl);?>
</th>
				<th data-hide="phone,tablet" class="item"><?php echo smartyTranslate(array('s'=>'Quantity'),$_smarty_tpl);?>
</th>
				<?php if ($_smarty_tpl->tpl_vars['order']->value->hasProductReturned()){?>
					<th data-hide="phone,tablet" class="item"><?php echo smartyTranslate(array('s'=>'Returned'),$_smarty_tpl);?>
</th>
				<?php }?>
				<th data-hide="phone,tablet" class="item"><?php echo smartyTranslate(array('s'=>'Unit price'),$_smarty_tpl);?>
</th>
				<th data-hide="phone,tablet" class="last_item"><?php echo smartyTranslate(array('s'=>'Total price'),$_smarty_tpl);?>
</th>
			</tr>
		</thead>
		<tfoot>
			<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value&&$_smarty_tpl->tpl_vars['use_tax']->value){?>
				<tr class="item">
					<td  colspan="<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value||$_smarty_tpl->tpl_vars['order']->value->hasProductReturned()){?><?php if ($_smarty_tpl->tpl_vars['order']->value->hasProductReturned()&&$_smarty_tpl->tpl_vars['return_allowed']->value){?>7<?php }else{ ?>6<?php }?><?php }else{ ?>5<?php }?>">
						<strong><?php echo smartyTranslate(array('s'=>'Total products (tax excl.)'),$_smarty_tpl);?>
			...
			<tr class="item">
				<td  colspan="<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value||$_smarty_tpl->tpl_vars['order']->value->hasProductReturned()){?><?php if ($_smarty_tpl->tpl_vars['order']->value->hasProductReturned()&&$_smarty_tpl->tpl_vars['return_allowed']->value){?>7<?php }else{ ?>6<?php }?><?php }else{ ?>5<?php }?>">
					<strong><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
...
<?php }?>: </strong> <span class="price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPriceWithCurrency'][0][0]->displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['order']->value->getTotalProductsWithTaxes(),'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl);?>
			...
			<tr class="item">
				<td  colspan="<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value||$_smarty_tpl->tpl_vars['order']->value->hasProductReturned()){?><?php if ($_smarty_tpl->tpl_vars['order']->value->hasProductReturned()&&$_smarty_tpl->tpl_vars['return_allowed']->value){?>7<?php }else{ ?>6<?php }?><?php }else{ ?>5<?php }?>">
					<strong><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
 <?php if ($_smarty_tpl->tpl_vars['use_tax']->value){?><?php echo smartyTranslate(array('s'=>'(tax incl.)'),$_smarty_tpl);?>
...
<?php if (count($_smarty_tpl->tpl_vars['order']->value->getShipping())>0){?>
	<table id="shipping-table" class="std shop_table footable">
		<thead>
			<tr>
				<th data-class="expand"  class="first_item"><?php echo smartyTranslate(array('s'=>'Date'),$_smarty_tpl);?>
</th>
				<th data-hide="phone,tablet" class="item"><?php echo smartyTranslate(array('s'=>'Carrier'),$_smarty_tpl);?>
</th>
				<th data-hide="phone,tablet" class="item"><?php echo smartyTranslate(array('s'=>'Weight'),$_smarty_tpl);?>
</th>
				<th data-hide="phone,tablet" class="item"><?php echo smartyTranslate(array('s'=>'Shipping cost'),$_smarty_tpl);?>
</th>
				<th data-hide="phone,tablet" class="last_item"><?php echo smartyTranslate(array('s'=>'Tracking number'),$_smarty_tpl);?>
</th>
			</tr>
		</thead>
		<tbody>
...
<?php if (!$_smarty_tpl->tpl_vars['is_guest']->value){?>
	...
	<div id="returnOrderMessage" class="titled_box">
		<h2><span><?php echo smartyTranslate(array('s'=>'Merchandise return'),$_smarty_tpl);?>
</span></h2>
...
" method="post" class="std titled_box" id="sendOrderMessage">
		<h2><span><?php echo smartyTranslate(array('s'=>'Add a message'),$_smarty_tpl);?>
</span></h2>
...
" />
			<input type="submit" class="btn btn-inverse" name="submitMessage" value="<?php echo smartyTranslate(array('s'=>'Send'),$_smarty_tpl);?>
"/>
		</p>
	</form>
<?php }else{ ?>
<p><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
icon/infos.png" alt="" class="icon" />&nbsp;<?php echo smartyTranslate(array('s'=>'You cannot return merchandise with a guest account'),$_smarty_tpl);?>
</p>
<?php }?>
<?php }} ?>