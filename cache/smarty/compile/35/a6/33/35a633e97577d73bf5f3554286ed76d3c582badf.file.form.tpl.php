<?php /* Smarty version Smarty-3.1.14, created on 2013-10-23 20:47:25
         compiled from "/var/www/admincups/themes/default/template/controllers/specific_price_rule/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:191984061052680badc8b7e0-09888094%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '35a633e97577d73bf5f3554286ed76d3c582badf' => 
    array (
      0 => '/var/www/admincups/themes/default/template/controllers/specific_price_rule/helpers/form/form.tpl',
      1 => 1382387021,
      2 => 'file',
    ),
    '2a81afc2496581a661ab035b9570c4631bbdd957' => 
    array (
      0 => '/var/www/admincups/themes/default/template/helpers/form/form.tpl',
      1 => 1382386707,
      2 => 'file',
    ),
    'e685b63ba2c63dfbb6e7c75246f2c1e3d8013141' => 
    array (
      0 => '/var/www/admincups/themes/default/template/helpers/form/form_group.tpl',
      1 => 1382386708,
      2 => 'file',
    ),
    '4277236f1233588626d6c48753e0288eb95fcc0e' => 
    array (
      0 => '/var/www/admincups/themes/default/template/helpers/form/form_category.tpl',
      1 => 1382386707,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '191984061052680badc8b7e0-09888094',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52680baebbe410_47683471',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52680baebbe410_47683471')) {function content_52680baebbe410_47683471($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/tools/smarty/plugins/modifier.escape.php';
?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '191984061052680badc8b7e0-09888094');
content_52680bae5f8a19_26640244($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_category.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('categories'=>$_smarty_tpl->tpl_vars['input']->value['values']), 0, '191984061052680badc8b7e0-09888094');
content_52680bae66d228_78199624($_smarty_tpl);
...
<div id="conditions" class="Bloc">
	...
	<a class="button bt-icon" href="#" id="add_condition_group">
		...
		<?php echo smartyTranslate(array('s'=>'Add a new condition group'),$_smarty_tpl);?>

	</a>
	<div id="condition_list">
		<h3><?php echo smartyTranslate(array('s'=>'Conditions'),$_smarty_tpl);?>
</h3>
		<div class="row">
			<label for="id_category"><?php echo smartyTranslate(array('s'=>'Category'),$_smarty_tpl);?>
</label>
				<div class="margin-form">
...
">(<?php echo intval($_smarty_tpl->tpl_vars['category']->value['id_category']);?>
					...
					<a class="button bt-icon" href="#" id="add_condition_category">
						<img src="../img/admin/add.gif" />
							<?php echo smartyTranslate(array('s'=>'Add condition'),$_smarty_tpl);?>
		...
		<div class="row">
		<label for="id_manufacturer"><?php echo smartyTranslate(array('s'=>'Manufacturer'),$_smarty_tpl);?>
</label>
		<div class="margin-form">
...
"><?php echo $_smarty_tpl->tpl_vars['manufacturer']->value['name'];?>
		...
		<div class="row">
		<label for="id_supplier"><?php echo smartyTranslate(array('s'=>'Supplier'),$_smarty_tpl);?>
</label>
		<div class="margin-form">
...
"><?php echo $_smarty_tpl->tpl_vars['supplier']->value['name'];?>
		...
		<div class="row">
		<label for="id_attribute"><?php echo smartyTranslate(array('s'=>'Attributes'),$_smarty_tpl);?>
</label>
		<div class="margin-form">
...
"><?php echo $_smarty_tpl->tpl_vars['attribute']->value['name'];?>
		...
		<div class="row">
		<label for="id_attribute"><?php echo smartyTranslate(array('s'=>'Features'),$_smarty_tpl);?>
</label>
		<div class="margin-form">
...
function new_condition_group()
{
	...
	var html = '<div class="condition_group" id="condition_group_'+last_condition_group+'"><h3><?php echo smartyTranslate(array('s'=>'Condition group'),$_smarty_tpl);?>
 '+last_condition_group+'</h3>';
		html += '<table cellspacing="0" cellpadding="0" class="table width3"><thead><tr><th width="196px" height="39"><?php echo smartyTranslate(array('s'=>'Type'),$_smarty_tpl);?>
</th><th width="300px"><?php echo smartyTranslate(array('s'=>'Value'),$_smarty_tpl);?>
</th><th></th></tr></thead><tbody></tbody></table>';
		html += '</div><div class="condition_separator"><?php echo smartyTranslate(array('s'=>'OR'),$_smarty_tpl);?>
...
function appendConditionToGroup(html)
{
	if ($('#condition_group_'+current_id_condition_group+' table tbody tr').length > 0)
		$('#condition_group_'+current_id_condition_group+' table tbody').append('<tr><td align="center" class="btn_delete_condition" colspan="3"><b><?php echo smartyTranslate(array('s'=>'AND','js'=>1),$_smarty_tpl);?>
</b></td></tr>');
...
$(document).ready(function() {
...
</td><td>'+$('#id_category option:selected').html()+'</td><td><a href="#" onclick="delete_condition(\''+id_condition+'\');"><img src="../img/admin/delete.gif" /></a></td></tr>';
...
</td><td>'+$('#id_manufacturer option:selected').html()+'</td><td><a href="#" onclick="delete_condition(\''+id_condition+'\');"><img src="../img/admin/delete.gif" /></a></td></tr>';
		appendConditionToGroup(html);
...
</td><td>'+$('#id_supplier option:selected').html()+'</td><td><a href="#" onclick="delete_condition(\''+id_condition+'\');"><img src="../img/admin/delete.gif" /></a></td></tr>';
		appendConditionToGroup(html);
...
</td><td>'+$('#id_attribute_group option:selected').html()+': '+$('#id_attribute_'+$('#id_attribute_group option:selected').val()+' option:selected').html()+'</td><td><a href="#" onclick="delete_condition(\''+id_condition+'\');"><img src="../img/admin/delete.gif" /></a></td></tr>';
		appendConditionToGroup(html);
...
</td><td>'+$('#id_feature option:selected').html()+': '+$('#id_feature_'+$('#id_feature option:selected').val()+' option:selected').html()+'</td><td><a href="#" onclick="delete_condition(\''+id_condition+'\');"><img src="../img/admin/delete.gif" /></a></td></tr>';
		appendConditionToGroup(html);
	...
	<?php if (count($_smarty_tpl->tpl_vars['conditions']->value)==0){?>
		new_condition_group();
	<?php }?>
...
<?php }?>
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2013-10-23 20:47:26
         compiled from "/var/www/admincups/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_52680bae5f8a19_26640244')) {function content_52680bae5f8a19_26640244($_smarty_tpl) {?>
...
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2013-10-23 20:47:26
         compiled from "/var/www/admincups/themes/default/template/helpers/form/form_category.tpl" */ ?>
<?php if ($_valid && !is_callable('content_52680bae66d228_78199624')) {function content_52680bae66d228_78199624($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/var/www/tools/smarty/plugins/function.implode.php';
?>
