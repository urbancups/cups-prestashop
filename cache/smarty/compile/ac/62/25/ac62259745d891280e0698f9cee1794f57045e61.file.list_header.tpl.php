<?php /* Smarty version Smarty-3.1.14, created on 2013-10-30 22:54:54
         compiled from "/var/www/admincups/themes/default/template/controllers/stock_cover/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18898889735271721e1fd228-42353272%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ac62259745d891280e0698f9cee1794f57045e61' => 
    array (
      0 => '/var/www/admincups/themes/default/template/controllers/stock_cover/helpers/list/list_header.tpl',
      1 => 1382387030,
      2 => 'file',
    ),
    '12bc1becdb432df8b0012bd285e88d4bb138834e' => 
    array (
      0 => '/var/www/admincups/themes/default/template/helpers/list/list_header.tpl',
      1 => 1382386728,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18898889735271721e1fd228-42353272',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5271721e60b899_24242250',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5271721e60b899_24242250')) {function content_5271721e60b899_24242250($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/tools/smarty/plugins/modifier.escape.php';
?>
...
" />
	...
	<div>
			<label for="coverage_period"><?php echo smartyTranslate(array('s'=>'Filter by period:'),$_smarty_tpl);?>
</label>
			<select name="coverage_period" onChange="$(this).parent().parent().submit();">
				<?php  $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['i']->_loop = false;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['stock_cover_periods']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
"><?php echo $_smarty_tpl->tpl_vars['k']->value;?>
	...
	<div>
			<label for="id_warehouse"><?php echo smartyTranslate(array('s'=>'Filter by warehouse:'),$_smarty_tpl);?>
</label>
			<select name="id_warehouse" onChange="$(this).parent().parent().submit();"">
				<?php  $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['i']->_loop = false;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['stock_cover_warehouses']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['i']->key => $_smarty_tpl->tpl_vars['i']->value){
$_smarty_tpl->tpl_vars['i']->_loop = true;
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['i']->key;
?>
...
"><?php echo $_smarty_tpl->tpl_vars['i']->value['name'];?>
	...
	<?php }?>
	<div>
		<label for="warn_days"><?php echo smartyTranslate(array('s'=>'Highlight when coverage (in days) is less than:'),$_smarty_tpl);?>
</label>
		<input name="warn_days" type="text" size="3" onChange="$(this).parent().parent().submit();" 
			   value="<?php if (isset($_smarty_tpl->tpl_vars['stock_cover_warn_days']->value)){?><?php echo $_smarty_tpl->tpl_vars['stock_cover_warn_days']->value;?>
<?php }?>">
		</input>
	</div>
	</form>
