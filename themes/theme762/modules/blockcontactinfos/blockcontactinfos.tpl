...
<section class="block blockcontactinfos span3">
	...
	<ul class="toggle_content">
		...
		{if $blockcontactinfos_address != ''}<li class="bot3">{$blockcontactinfos_address|escape:'htmlall':'UTF-8'}</li>{/if}	
		...
		{if $blockcontactinfos_phone != ''}<li class="tel">{l mod='blockcontactinfos'} {$blockcontactinfos_phone|escape:'htmlall':'UTF-8'}</li>{/if}
	</ul>
</section>
