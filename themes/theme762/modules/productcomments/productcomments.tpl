				...
				<div class="comment_details">
					...
					<ul>
						...
						{if $logged == 1}
							...
							<li>{l s='Was this comment useful to you?' mod='productcomments'}<div class="clearfix"><button class="btn btn-inverse" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">{l s='yes' mod='productcomments'}</button> <button class="btn btn-inverse" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">{l s='no' mod='productcomments'}</button></div></li>
							{/if}
