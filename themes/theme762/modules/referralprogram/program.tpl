...
<ul class="footer_links">
	<li><a href="{$link->getPageLink('my-account', true)}"><i class="icon-user"></i> {l s='Back to Your Account' mod='referralprogram'}</a></li>
	<li class="f_right"><a href="{$base_dir}"><i class="icon-home"></i> {l s='Home' mod='referralprogram'}</a></li>
</ul>
