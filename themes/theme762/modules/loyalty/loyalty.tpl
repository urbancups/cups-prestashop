...
<div class="block-center" id="block-history">
	...
	<table id="order-list" class="std footable">
		<thead>
			<tr>
		...
		<tfoot>
			<tr class="alternate_item">
				<td colspan="4" class="history_method bold" style="text-align:center;">{l s='Total points available:' mod='loyalty'} : {$totalPoints|intval}</td>
			</tr>
		</tfoot>
		<tbody>
...
<ul class="footer_links">
	<li><a href="{$link->getPageLink('my-account', true)}"><i class="icon-user"></i> {l s='Back to Your Account' mod='loyalty'}</a></li>
