...
class CustomContent2 extends Module{
  ...
  {
    $this->name = 'customcontent2';    // Defines module name
    ...
    $this->displayName = $this->l('customcontent2');
    $this->desctiption = $this->l('customcontent2 description');
  }
